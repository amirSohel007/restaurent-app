const restaurants =  [
  {
    ...
    price: "₹ 534",
    photograph: "https://b.zmtcdn.com/data/collections/2e5c5dc79d4b465797c8e425d814f42c_1582256432.jpg",
...
function renderRestaurentCardsView(restaurants) {
  restaurants.forEach((shop) => {
    document.querySelector(".restaurent-listing").insertAdjacentHTML(
      "afterbegin",
      `<div class="col-sm-4">
...
renderRestaurentCardsView(restaurants)